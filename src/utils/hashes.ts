...
import * as selectionDefinitions from '~/selections/$selections.ts';
import { getSelections } from '~/utils/get.ts';
				...
				enter(node: any) {
					if (
						...
						if (secondArgument.type === 'ObjectExpression') {
							...
							const expandedSelectionFunctionsObject = expandSelectionFunctions(
								{
